...
# Setup Flask to designate where uploaded files are temporarily stored
app = Flask(__name__)
...
def index():
    ...
    if request.method == "POST":
        ...
        if uploaded_file and allowed_file(uploaded_file.filename): #Calling function to check if file is allowed
            ...
            try:
                ...
                if os.path.exists(filepath):
                    os.remove(filepath)  # Ensure file is deleted even on failure
        else:
